...
- **@optimizely/cms-sdk ^3.0.0** — headless content client (Optimizely Graph)
- **@optimizely/cms-cli ^3.0.0** — syncs TypeScript content-type definitions to the CMS (`yarn cms:push` / `cms:pull`)
