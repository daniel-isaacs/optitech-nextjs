  ...
  return (
    <>
      ...
      {/* ════════════════════════════════════════════════════════════════
          BLOG PAGE
          ════════════════════════════════════════════════════════════════ */}
      <section id="blog-page" className="border-t border-fg/10 pt-xl">
        <div className="px-md lg:px-lg pb-lg">
          <SectionLabel index="09 · Page" title="BlogPage" />
          <p className="text-title font-semibold text-fg mt-sm">OT_BlogPage</p>
          <p className="text-body text-fg-muted mt-xs max-w-[60ch]">
            A <code className="font-mono text-accent">_page</code> content type rendered by its own component — not a Visual Builder composition. Includes a brand-filled article header, featured media, rich-text body, and an automated latest-posts rail.
          </p>
        </div>
