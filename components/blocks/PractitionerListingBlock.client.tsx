          ...
          {showSearch && (
            <div className="relative max-w-md">
              ...
              <input
                ...
                className={`${inputBg} w-full rounded-input border border-fg/15 py-sm pl-10 pr-sm text-body text-fg placeholder:text-fg-muted/60 focus:border-brand focus:outline-2 focus:outline-offset-0 focus:outline-brand`}
              />
            </div>
          )}
